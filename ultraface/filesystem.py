...
TEMP_DIRECTORY_PATH = os.path.join(tempfile.gettempdir(), 'ultraface')
...
def get_temp_frames_pattern(target_path : str, temp_frame_prefix : str) -> str:
	...
	return os.path.join(temp_directory_path, temp_frame_prefix + '.' + ultraface.globals.temp_frame_format)
...
def clear_temp(target_path : str) -> None:
	...
	if not nextface.globals.keep_temp and is_directory(temp_directory_path):
